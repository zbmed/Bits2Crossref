...
RUN curl https://repo1.maven.org/maven2/net/sf/saxon/Saxon-HE/${SAXON_VERSION}/Saxon-HE-${SAXON_VERSION}.jar -o /saxon/saxon-he-${SAXON_VERSION}.jar
ADD ./saxon/saxon-he-${SAXON_VERSION}.jar /saxon/saxon-he-${SAXON_VERSION}.jar
