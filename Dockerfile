...
RUN curl https://repo1.maven.org/maven2/net/sf/saxon/Saxon-HE/${SAXON_VERSION}/Saxon-HE-${SAXON_VERSION}.jar -o /usr/src/basex/basex-api/lib/saxon-he-${SAXON_VERSION}.jar
